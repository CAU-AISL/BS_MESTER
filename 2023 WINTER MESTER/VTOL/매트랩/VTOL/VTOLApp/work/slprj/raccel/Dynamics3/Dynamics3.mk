###########################################################################
## Makefile generated for component 'Dynamics3'. 
## 
## Makefile     : Dynamics3.mk
## Generated on : Tue Feb 27 14:42:14 2024
## Final product: ./Dynamics3.exe
...
START_DIR                 = C:/Users/USER/OneDrive/문서/MATLAB/Examples/R2023b/uav/CustomizeVTOLConfigurationForYourApplicationExample/VTOLApp/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = Dynamics3_ref.rsp
COMPILER_COMMAND_FILE     = Dynamics3_comp.rsp
CMD_FILE                  = Dynamics3.rsp
...
DEFINES_STANDARD = -DMODEL=Dynamics3 -DNUMST=2 -DNCSTATES=19 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3.c $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_capi.c $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_data.c $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_tgtconn.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = Dynamics3.obj Dynamics3_capi.obj Dynamics3_data.obj Dynamics3_tgtconn.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
MODELREF_LIBS = C:/Users/USER/OneDrive/문서/MATLAB/Examples/R2023b/uav/CustomizeVTOLConfigurationForYourApplicationExample/VTOLApp/work/slprj/sim/PropellerDynamics/PropellerDynamicslib.lib
...
%.obj : $(START_DIR)/slprj/raccel/Dynamics3/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Dynamics3/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Dynamics3/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Dynamics3/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Dynamics3/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Dynamics3.obj : $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Dynamics3_capi.obj : $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Dynamics3_data.obj : $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Dynamics3_tgtconn.obj : $(START_DIR)/slprj/raccel/Dynamics3/Dynamics3_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
