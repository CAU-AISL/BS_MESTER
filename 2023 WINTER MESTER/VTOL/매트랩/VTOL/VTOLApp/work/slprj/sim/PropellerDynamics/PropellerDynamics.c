...
real_T eoxyrq1xn4 ; real_T erljv0tbvz ; real_T l21iumy13n ; real_T npp33pyly2
; real_T od5o4bkp0y ; real_T pvw5j2urh0 ; cl1xecblr0 = jgodcikh13 [ 0 ] *
e4xmvna52m [ 1 ] ; erljv0tbvz = jgodcikh13 [ 1 ] * e4xmvna52m [ 2 ] ;
l21iumy13n = e4xmvna52m [ 0 ] * jgodcikh13 [ 2 ] ; cufvm1stfs = jgodcikh13 [
0 ] * e4xmvna52m [ 2 ] ; eoxyrq1xn4 = e4xmvna52m [ 0 ] * jgodcikh13 [ 1 ] ;
pvw5j2urh0 = e4xmvna52m [ 1 ] * jgodcikh13 [ 2 ] ; erljv0tbvz = ( erljv0tbvz
- pvw5j2urh0 ) + de0biblu0l [ 0 ] ; l21iumy13n = ( l21iumy13n - cufvm1stfs )
+ de0biblu0l [ 1 ] ; cl1xecblr0 = ( cl1xecblr0 - eoxyrq1xn4 ) + de0biblu0l [
2 ] ; eoxyrq1xn4 = erljv0tbvz * p1nux5b0nf [ 0 ] ; eoxyrq1xn4 += l21iumy13n *
p1nux5b0nf [ 1 ] ; eoxyrq1xn4 += cl1xecblr0 * p1nux5b0nf [ 2 ] ; erljv0tbvz =
eoxyrq1xn4 * p1nux5b0nf [ 0 ] ; l21iumy13n = erljv0tbvz * erljv0tbvz ;
erljv0tbvz = eoxyrq1xn4 * p1nux5b0nf [ 1 ] ; l21iumy13n += erljv0tbvz *
erljv0tbvz ; erljv0tbvz = eoxyrq1xn4 * p1nux5b0nf [ 2 ] ; l21iumy13n +=
erljv0tbvz * erljv0tbvz ; if ( rtmIsMajorTimeStep ( n3istur3p5 ) ) { if (
localDW -> cmbvvgaq02 != 0 ) { ssSetBlockStateForSolverChangedAtMajorStep (
n3istur3p5 -> _mdlRefSfcnS ) ;
ssSetContTimeOutputInconsistentWithStateAtMajorStep ( n3istur3p5 ->
_mdlRefSfcnS ) ; localDW -> cmbvvgaq02 = 0 ; } erljv0tbvz =
muDoubleScalarSqrt ( l21iumy13n ) ; } else if ( l21iumy13n < 0.0 ) {
erljv0tbvz = - muDoubleScalarSqrt ( muDoubleScalarAbs ( l21iumy13n ) ) ;
localDW -> cmbvvgaq02 = 1 ; } else { erljv0tbvz = muDoubleScalarSqrt (
l21iumy13n ) ; } if ( ssIsModeUpdateTimeStep ( n3istur3p5 -> _mdlRefSfcnS ) )
{ if ( * akzpwcud41 >= ht5n2qntkh . P_2 ) { localDW -> cu55bydicj = 1 ; }
else if ( * akzpwcud41 > rtP_minPWM ) { localDW -> cu55bydicj = 0 ; } else {
localDW -> cu55bydicj = - 1 ; } } if ( localDW -> cu55bydicj == 1 ) {
l21iumy13n = ht5n2qntkh . P_2 ; } else if ( localDW -> cu55bydicj == - 1 ) {
l21iumy13n = rtP_minPWM ; } else { l21iumy13n = * akzpwcud41 ; } * bdy3wtdo2m
= rtP_uavParam . motor . RPMMAX / 60.0 * l21iumy13n ; l21iumy13n =
rtP_uavParam . geom . PropDiameter * * bdy3wtdo2m ; erljv0tbvz /= l21iumy13n
; l21iumy13n = * bdy3wtdo2m * * bdy3wtdo2m ; cl1xecblr0 = ( ( ( ht5n2qntkh .
P_3 [ 0 ] * erljv0tbvz + ht5n2qntkh . P_3 [ 1 ] ) * erljv0tbvz + ht5n2qntkh .
P_3 [ 2 ] ) * erljv0tbvz + ht5n2qntkh . P_3 [ 3 ] ) * ( l21iumy13n *
rtP_uavParam . aero . rho * localB -> g33x3brnwl ) ; d5ttxibnex [ 0 ] =
p1nux5b0nf [ 0 ] * cl1xecblr0 * ht5n2qntkh . P_6 ; d5ttxibnex [ 1 ] =
p1nux5b0nf [ 1 ] * cl1xecblr0 * ht5n2qntkh . P_6 ; d5ttxibnex [ 2 ] =
p1nux5b0nf [ 2 ] * cl1xecblr0 * ht5n2qntkh . P_6 ; cl1xecblr0 = ht5n2qntkh .
P_4 * fcurtqao22 [ 2 ] ; cufvm1stfs = e4xmvna52m [ 0 ] * d5ttxibnex [ 1 ] ;
pvw5j2urh0 = e4xmvna52m [ 1 ] * d5ttxibnex [ 2 ] ; od5o4bkp0y = d5ttxibnex [
0 ] * e4xmvna52m [ 2 ] ; annb3lflth = e4xmvna52m [ 0 ] * d5ttxibnex [ 2 ] ;
npp33pyly2 = d5ttxibnex [ 0 ] * e4xmvna52m [ 1 ] ; d412fnruld = d5ttxibnex [
1 ] * e4xmvna52m [ 2 ] ; eoxyrq1xn4 = ( ( ( ( ht5n2qntkh . P_5 [ 0 ] *
erljv0tbvz + ht5n2qntkh . P_5 [ 1 ] ) * erljv0tbvz + ht5n2qntkh . P_5 [ 2 ] )
* erljv0tbvz + ht5n2qntkh . P_5 [ 3 ] ) * erljv0tbvz + ht5n2qntkh . P_5 [ 4 ]
) * ( l21iumy13n * rtP_uavParam . aero . rho * localB -> f4sjvlzpnp ) *
cl1xecblr0 ; erljv0tbvz = eoxyrq1xn4 * p1nux5b0nf [ 0 ] ; l21iumy13n =
eoxyrq1xn4 * p1nux5b0nf [ 1 ] ; cl1xecblr0 = eoxyrq1xn4 * p1nux5b0nf [ 2 ] ;
bumzwrs5da [ 0 ] = ( pvw5j2urh0 - d412fnruld ) + erljv0tbvz ; bumzwrs5da [ 1
] = ( od5o4bkp0y - annb3lflth ) + l21iumy13n ; bumzwrs5da [ 2 ] = (
cufvm1stfs - npp33pyly2 ) + cl1xecblr0 ; } void PropellerDynamicsTID1 (
hdlladljw4 * localB ) { localB -> g33x3brnwl = muDoubleScalarPower (
rtP_uavParam . geom . PropDiameter , ht5n2qntkh . P_7 ) ; localB ->
f4sjvlzpnp = muDoubleScalarPower ( rtP_uavParam . geom . PropDiameter ,
ht5n2qntkh . P_8 ) ; } void ctvtngd0gv ( ndzwvtjpgv * const n3istur3p5 ) { if
( ! slIsRapidAcceleratorSimulating ( ) ) { slmrRunPluginEvent ( n3istur3p5 ->
_mdlRefSfcnS , "PropellerDynamics" ,
